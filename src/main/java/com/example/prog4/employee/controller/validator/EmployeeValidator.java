...
public class EmployeeValidator {
    ...
    public void validate(Employee employee) {
        ...
        if (!StringValidator.isNotNullAndNotBlank(employee.getLastName())) {
            error.append("Last name is mandatory. ");
        }
        if (!StringValidator.isNotNullAndNotBlank(employee.getFirstName())) {
        ...
        if (!StringValidator.isNotNullAndNotBlank(employee.getAddress())) {
            error.append("Address is mandatory. ");
        }
        if (employee.getSex() == null) {
            error.append("Sex is mandatory. ");
        }
        if (!StringValidator.isNotNullAndNotBlank(employee.getCin())) {
        ...
        if (!StringValidator.isNotNullAndNotBlank(employee.getProfessionalEmail())) {
            error.append("Professional email is mandatory. ");
        }
        if (!StringValidator.isNotNullAndNotBlank(employee.getPersonalEmail())) {
            error.append("Personal email is mandatory. ");
        }
        if (!StringValidator.isNotNullAndNotBlank(employee.getCnaps())) {
