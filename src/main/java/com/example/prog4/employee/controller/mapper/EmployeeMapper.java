...
import com.example.prog4.employee.entity.Phone;
...
public class EmployeeMapper {
    ...
    public com.example.prog4.employee.entity.Employee toDomain(Employee employee) {
        try {
            ...
            com.example.prog4.employee.entity.Employee domainEmployee = com.example.prog4.employee.entity.Employee.builder()
                    .id(employee.getId())
    ...
    public Employee toView(com.example.prog4.employee.entity.Employee employee) {
